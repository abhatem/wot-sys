...
export class WotSenseHat {
    ...
    private addPropertyHandlers() {
        ...
        this.thing.setPropertyWriteHandler("displayRotation", 
        (val ,options) => { 
        ...
        this.thing.setPropertyWriteHandler("pixels", 
        (val ,options) => { 
            return new Promise((resolve, reject) => {
        ...
        this.thing.setPropertyWriteHandler("lowLight", 
        (val ,options) => { 
            return new Promise((resolve, reject) => {
...
// ------------------------  Properties  ------------------------
    ...
    private set_rotation(angle: any) {
        return new Promise((resolve, reject) => {
...
// ------------------------  Actions  ------------------------
    ...
    private show_letter(message: { letter: string, text_colour?: number[], back_colour?: number[] }) {
        return new Promise((resolve, reject) => {
